...
typedef struct {
  ...
  real_T Delay_DSTATE_bc;
  real_T Delay1_DSTATE_l;
  real_T Delay_DSTATE_gt;
  real_T Delay_DSTATE_ij;
  real_T Delay_DSTATE_fz;
  real_T Delay_DSTATE_ed;
...
struct Parameters_FlyByWire_T_ {
  ...
  real_T Delay1_InitialCondition_mf;
  real_T Gain_Gain_hk;
  real_T Saturation1_UpperSat_h;
  real_T Saturation1_LowerSat_g;
  real_T Delay_InitialCondition_mr;
  ...
  real_T Saturation_LowerSat_nm;
  real_T Saturation_UpperSat_h;
  real_T Saturation_LowerSat_h2;
